...
public class JobApplicationService {
    ...
    public void addJobApplication(JobApplicationRequestDTO jobApplicationDTO, String email) {
        ...
        JobApplication jobApplication = JobApplication.builder().title(jobApplicationDTO.getTitle()).summary(jobApplicationDTO.getSummary()).companyName(jobApplicationDTO.getCompanyName())
                ...
                .status(defaultStatus).resume(jobApplicationDTO.getResume()).user(user).active(true).build();
